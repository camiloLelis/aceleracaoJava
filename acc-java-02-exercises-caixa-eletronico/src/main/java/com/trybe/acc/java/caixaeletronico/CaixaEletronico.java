  ...
  public static void main(String[] args) {
    ...
    try (Scanner sc = new Scanner(System.in)) {
      ...
      PessoaCliente pessoaCliente1 =
          banco.adicionarPessoaCliente("Alexiania", "Poupança", "842.074.410-77", "1234");
      banco.adicionarConta("Corrente", pessoaCliente1);

      // pessoa cliente 2
      PessoaCliente pessoaCliente2 =
          banco.adicionarPessoaCliente("Abadiania Silva", "Poupança", "848.725.510-87", "1234");
      banco.adicionarConta("Corrente", pessoaCliente2);

      // pessoa cliente 3
      PessoaCliente pessoaCliente3 =
          banco.adicionarPessoaCliente("Camaragibe Oliveira", "Poupança", "433.892.200-11", "1234");
        ...
        if (pessoaClienteAutenticada == null) {
          ...
          do {
            ...
            if (op == 1) {
              ...
              // pega o indice da conta para Depósito
              do {
                System.out.printf(
